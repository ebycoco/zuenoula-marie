...
class MotmaireCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return Motmaire::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $image = ImageField::new('imageName')->setBasePath('/images/mot_maire');
        $fields = [
            TextField::new('nom'),
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste ')
