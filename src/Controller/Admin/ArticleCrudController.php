...
class ArticleCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $image = ImageField::new('imageName', 'Image')->setBasePath('/images/article');
        $fields = [
            TextField::new('titre'),
            TextEditorField::new('contenue')->hideOnIndex(),
            BooleanField::new('active')->setPermission('ROLE_EDITOR'),
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_EDIT, 'Modification de la article')
