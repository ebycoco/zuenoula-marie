...
class AdministrationDeMunicipaliteCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return AdministrationDeMunicipalite::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            TextField::new('titre'),
            TextEditorField::new('contenue')->hideOnIndex(),
            AssociationField::new('user', 'Ajouter par')->hideOnIndex()->hideOnForm(),
            DateField::new('publishedAt')->hideOnForm(),
        ];
    }
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des administrations')
            ->setPageTitle(Crud::PAGE_EDIT, 'Modification de l\'administrations')
