...
class ImageSportCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return ImageSport::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $image = ImageField::new('imageName')->setBasePath('/images/sport');
        $fields = [
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des images de Sport')
