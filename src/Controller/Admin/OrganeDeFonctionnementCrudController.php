...
class OrganeDeFonctionnementCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return OrganeDeFonctionnement::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $image = ImageField::new('imageName', 'Image')->setBasePath('/images/organe');
        $fields = [
            TextField::new('titre'),
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des organes')
