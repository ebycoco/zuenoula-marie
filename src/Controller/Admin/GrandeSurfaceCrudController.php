...
class GrandeSurfaceCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return GrandeSurface::class;
    }
    public function configureFields(string $pageName): iterable
    {
        // $this->denyAccessUnlessGranted('ROLE_ADMIN');
        $imageFile = TextField::new('imageFile')->setFormType(VichImageType::class);
        $image = ImageField::new('imageName', 'Image')->setBasePath('/images/grande_surface');
        $fields = [
            TextField::new('titre'),
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des grandes surface')
